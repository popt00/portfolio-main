                        ...
                        <div className='flex items-center sm:mx-10 md:mx-10 justify-between w-full'>
                                ...
                                <h1 className=' font-bold text-xl cursor-pointer'>
                                    <Link href='/'>
                                        <a className='text-2xl pl-8 sm:pl-0'>
                                            Parimal<span className='text-blue-500'>Donga</span>
                                        </a>
                                    </Link>
                                </h1>
                            </div>
                            ...
                            <div className= 'flex justify-center items-center flex-shrink-0 md:block'>
                                <div className='flex space-x-4'>
                                    <div>
                                        <a href='https://github.com/popt00/' target='_blank' rel='noopener noreferrer'>
                                            <BsGithub className='hidden md:block' size='2rem' />
                                        </a>
                                    </div>
                                    <div>
                                        <a href='https://www.linkedin.com/in/parimal-donga/'
                                            target='_blank'
                                    ...
                                    <div>
                                        <a href='https://leetcode.com/popt_/' target='_blank' rel='noopener noreferrer'>
                                            <SiLeetcode className='hidden md:block' size='2rem' />
                                        </a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div className='space-x-4 pt-20'>
                                    <div className='flex space-x-4'>
                                        ...
                                        <div className='rounded shadow-lg shadow-gray-400 p-3 cursor-pointer'>
                                            <a
                                                href='https://www.linkedin.com/in/parimal-donga/'
                                                target='_blank'
                                                rel='noopener noreferrer'
                                            >
